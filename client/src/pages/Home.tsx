...
function ProjectView() {
  const [projects, setProjects] = useState<Project[]>([
    { id: 1, title: "New auditorium chairs", description: "Replace the main auditorium seating before the October thanksgiving service.", target: 4500000, raised: 2860000, status: "Active", deadline: "Oct 12, 2024", leader: "Pastor Daniel", link: "https://paystack.com/pay/living-hope-chairs" },
